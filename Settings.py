...
# Frame rate settings (default to 60fps)
FPS = 60
...
# Fullscreen toggle button images
...
# FPS toggle button images
FPS_TOGGLE_BUTTON_IMAGE = pygame.image.load('Images/IconsWenrexa/09.png')
FPS_TOGGLE_BUTTON_HOVER_IMAGE = pygame.image.load('Images/IconsWenrexa/08.png')
...
# Function to load images for the parallax scrolling background
def load_images():
    background_images = {
...
# Helper function to load layered images from a folder
